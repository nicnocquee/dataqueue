...
ALTER TABLE job_queue ADD COLUMN idempotency_key VARCHAR(255);
CREATE UNIQUE INDEX idx_job_queue_idempotency_key ON job_queue (idempotency_key) WHERE idempotency_key IS NOT NULL;
