...
The third argument provides two methods to extend the job's timeout deadline while it's running:
...
See [Job Timeout](/docs/usage/job-timeout) for detailed usage examples.
