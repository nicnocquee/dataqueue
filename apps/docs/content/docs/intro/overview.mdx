...
DataQueue is a lightweight library that helps you manage your job queue in a Postgres database. It has two main components: the processor, the queue, and the job. It is not an external tool or service. You install DataQueue in your project and use it to add jobs to the queue, process them, and more, using your own existing Postgres database.
