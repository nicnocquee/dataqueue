...
const jobDefinitions: JobDefinition[] = [
  {
    ...
    title: 'Email Job',
    description:
      'Simulates sending an email. A simple fire-and-forget job that calls the email service with to, subject, and body fields.',
  ...
  },
  {
    ...
    title: 'Report Job',
    description:
      'Simulates generating a report for a user. Another straightforward job demonstrating basic job creation and processing.',
    features: ['Basic job creation and processing'],
  ...
  },
  {
    ...
    title: 'Image Job',
    description:
      'Simulates AI image generation with a 5-second timeout. Demonstrates timeout handling features.',
    features: [
